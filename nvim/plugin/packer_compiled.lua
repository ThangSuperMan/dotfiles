...
_G.packer_plugins = {
  ...
  ["lspkind-nvim"] = {
    config = { "\27LJ\2\nº\5\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\15symbol_map\1\0\25\15EnumMember\23 ÔÖù  (EnumMember)\fSnippet\20 ÔÉÑ  (Snippet)\rConstant\21 Ô≤Ä  (Constant)\fKeyword\20 Ô†ä  (Keyword)\vStruct\19 Ô≥§  (Struct)\tEnum\16 Ô©ó (Enum)\nEvent\18 ÔÉß  (Event)\nValue\18 Ô¢ü  (Value)\vMethod\19 Ôö¶  (Method)\tUnit\17 Ôëµ  (Unit)\rFunction\21 Ôûî  (Function)\rProperty\20 Ô™∂ (Property)\tText\18 Ôíû  (Text) \18TypeParameter\26 ÔûÉ  (TypeParameter)\vModule\19 Ôô®  (Module)\rOperator\21 Ôó´  (Operator)\14Interface\22 Ô∞Æ  (Interface)\nClass\18 Ô†ñ  (Class)\rVariable\21[Óúñ] (Variable)\nField\18 Ô∞†  (Field)\16Constructor\24 Ôê•  (Constructor)\vFolder\19 Ôùä  (Folder)\14Reference\22 Ôúú  (Reference)\tFile\17 Ôúì  (File)\nColor\18 Ô£ó  (Color)\1\0\2\vpreset\rcodicons\tmode\vsymbol\tinit\flspkind\frequire\0" },
    loaded = true,
